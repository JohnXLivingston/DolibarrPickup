...
/**
 * \file    test/functional/PickupFunctionalTest.php
 * \ingroup pickup
 ...
 * @package Testpickup
 */
class PickupFunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
...
//        )
	...
	{
		$this->url('/custom/pickup/admin/setup.php');
		$this->authenticate();
		return $this->assertContains('pickup/admin/setup.php', $this->url(), 'Configuration page');
	}
	...
	{
		$this->url('/custom/pickup/admin/about.php');
		$this->authenticate();
		return $this->assertContains('pickup/admin/about.php', $this->url(), 'About page');
	}
...
return $this->assertEquals(
	...
	public function testBoxDeclared()
	{
		...
		$this->authenticate();
		return $this->assertContains('pickupwidget1', $this->source(), "Box enabled");
	}
...
return $this->assertContains(
			'interface_99_modPickup_PickupTriggers.class.php',
...
return $this->assertContains(
			'tick.png',
			$this->byXPath('//td[text()="interface_99_modPickup_MyTrigger.class.php"]/following::img')->attribute('src'),
			"Trigger enabled"
		);
	}
