...
/**
 * \file    test/functional/CollecteFunctionalTest.php
 * \ingroup collecte
 ...
 *
 * @package Testcollecte
 */
class CollecteFunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
...
//        )
	...
	{
		$this->url('/custom/collecte/admin/setup.php');
		$this->authenticate();
		return $this->assertContains('collecte/admin/setup.php', $this->url(), 'Configuration page');
	}
	...
	{
		$this->url('/custom/collecte/admin/about.php');
		$this->authenticate();
		return $this->assertContains('collecte/admin/about.php', $this->url(), 'About page');
	}
...
return $this->assertEquals(
	...
	public function testBoxDeclared()
	{
		...
		$this->authenticate();
		return $this->assertContains('collectewidget1', $this->source(), "Box enabled");
	}
...
return $this->assertContains(
			'interface_99_modCollecte_CollecteTriggers.class.php',
...
return $this->assertContains(
			'tick.png',
			$this->byXPath('//td[text()="interface_99_modCollecte_MyTrigger.class.php"]/following::img')->attribute('src'),
			"Trigger enabled"
		);
	}
