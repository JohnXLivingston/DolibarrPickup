...
--ALTER TABLE llx_collecte_dolinputcat ADD CONSTRAINT llx_collecte_dolinputcat_fk_field FOREIGN KEY (fk_field) REFERENCES llx_collecte_myotherobject(rowid);
