...
/**
 *  \file       pickup_agenda.php
 *  \ingroup    pickup
 *  \brief      Page of Pickup events
 */
...
$hookmanager->initHooks(array('pickupagenda','globalcard'));     // Note that conf->hooks_modules contains array
...
if ($object->id > 0)
{
	...
	dol_fiche_head($head, 'agenda', $langs->trans("Pickup"), -1, $object->picto);
    ...
    if (! empty($conf->agenda->enabled) && (!empty($user->rights->agenda->myactions->read) || !empty($user->rights->agenda->allactions->read) ))
    {
		...
		//print load_fiche_titre($langs->trans("ActionsOnPickup"), '', '');
