...
/**
 *  \file       collecte_agenda.php
 *  \ingroup    collecte
 *  \brief      Page of Collecte events
 */
...
$hookmanager->initHooks(array('collecteagenda','globalcard'));     // Note that conf->hooks_modules contains array
...
if ($object->id > 0)
{
	...
	dol_fiche_head($head, 'agenda', $langs->trans("Collecte"), -1, $object->picto);
    ...
    if (! empty($conf->agenda->enabled) && (!empty($user->rights->agenda->myactions->read) || !empty($user->rights->agenda->allactions->read) ))
    {
		...
		//print load_fiche_titre($langs->trans("ActionsOnCollecte"), '', '');
