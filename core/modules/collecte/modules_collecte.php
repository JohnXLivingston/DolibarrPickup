...
class ModeleNumRefCollecte {
  ...
  var $previx = 'COL';
	...
	function info()
	{
		...
		return $langs->trans("CollecteNumRefModelDesc", $this->prefix);
	}
   ...
   * Return next value
   *
   * @param   Collecte		$collecte	Object collecte
   * @param   string		$mode       'next' for next value or 'last' for last value
   * @return  string      			Value if OK, 0 if KO
   */
  public function getNextValue($collecte, $mode = 'next')
	{
    ...
    $numFinal = get_next_value($db, $mask, 'collecte_collecte', 'ref', $where, '', $collecte->date_collecte, $mode, false, null, null);
