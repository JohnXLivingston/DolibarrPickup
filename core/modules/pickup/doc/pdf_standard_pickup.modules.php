...
/**
*  \file       pickup/core/modules/pickup/doc/pdf_standard.modules.php
*  \ingroup    pickup
...
/**
*	Class to manage PDF template standard_pickup
*/
class pdf_standard_pickup extends ModelePDFPickup
{
	...
	*/
	public function write_file($object, $outputlangs, $srctemplatepath = '', $hidedetails = 0, $hidedesc = 0, $hideref = 0)
	{
		...
		/*
		if (!empty($conf->global->MAIN_GENERATE_PICKUP_WITH_PICTURE))
		{
		...
		*/
		...
		if ($conf->pickup->dir_output.'/pickup')
		{
			...
			if ($object->specimen)
			{
				$dir = $conf->pickup->dir_output.'/pickup';
			...
			if (file_exists($dir))
			{
				...
				// Set nblines with the new pickup lines content after hook
				$nblines = (is_array($object->lines) ? count($object->lines) : 0);
	...
	public function defineColumnField($object, $outputlangs, $hidedetails = 0, $hidedesc = 0, $hideref = 0) {
		...
		*/
		...
		$this->cols['deee'] = array(
			'rank' => $rank,
			'width' => 16, // in mm
			'status' => !empty($conf->global->PICKUP_USE_DEEE) ? true : false,
			'title' => array(
				'textkey' => 'DEEE',
				'align' => 'C'
			),
