...
/**
 *	\file       collecte/collecteindex.php
 *	\ingroup    collecte
 *	\brief      Home page of collecte top menu
 */
...
$langs->loadLangs(array("collecte@collecte"));

$action=GETPOST('action', 'alpha');


// Securite acces client
if (! $user->rights->collecte->read) accessforbidden();
...
// Draft MyObject
if (! empty($conf->collecte->enabled) && $user->rights->collecte->read)
{
	$langs->load("orders");
