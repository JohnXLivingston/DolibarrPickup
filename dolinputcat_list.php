...
// Ci dessous, le reste du code standard généré par le template de modulebuilder.
...
// $contextpage= GETPOST('contextpage', 'aZ')?GETPOST('contextpage', 'aZ'):'dolinputcatlist';   // To manage different context of search
...
// 	// Mass actions
// 	$objectclass='Dolinputcat';
// 	$objectlabel='Dolinputcat';
...
//$help_url="EN:Module_Dolinputcat|FR:Module_Dolinputcat_FR|ES:Módulo_Dolinputcat";
// $help_url='';
// $title = $langs->trans('ListOf', $langs->transnoentitiesnoconv("Dolinputcats"));
...
// $sql.=preg_replace('/s^,/', '', $hookmanager->resPrint);
...
// 	$id = $obj->rowid;
// 	header("Location: ".dol_buildpath('/collecte/dolinputcat_card.php', 1).'?id='.$id);
// 	exit;
// }
...
// $newcardbutton = dolGetButtonTitle($langs->trans('New'), '', 'fa fa-plus-circle', dol_buildpath('/collecte/dolinputcat_card.php', 1).'?action=create&backtopage='.urlencode($_SERVER['PHP_SELF']), '', $user->rights->collecte->write);

// print_barre_liste($title, $page, $_SERVER["PHP_SELF"], $param, $sortfield, $sortorder, $massactionbutton, $num, $nbtotalofrecords, 'title_companies', 0, $newcardbutton, '', $limit);

// Add code for pre mass action (confirmation or email presend form)
// $topicmail="SendDolinputcatRef";
// $modelmail="dolinputcat";
// $objecttmp=new Dolinputcat($db);
