...
/**
 *  \file       collecte_note.php
 *  \ingroup    collecte
 *  \brief      Car with notes on Collecte
 */
...
$hookmanager->initHooks(array('collectenote','globalcard'));     // Note that conf->hooks_modules contains array
...
$help_url='';
llxHeader('', $langs->trans('Collecte'), $help_url);
...
if ($id > 0 || ! empty($ref))
{
	...
	dol_fiche_head($head, 'note', $langs->trans("Collecte"), -1, $object->picto);
