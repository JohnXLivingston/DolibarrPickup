...
/**
 * \file        class/collecte.class.php
 * \ingroup     collecte
 * \brief       This file is a CRUD class file for Collecte (Create/Read/Update/Delete)
 */
 ...
 * Class for Collecte
 */
class Collecte extends CommonObject
{
	/**
	 * @var string ID to identify managed object
	 */
	public $element = 'collecte';

	/**
	 * @var string Name of table without prefix where object is stored
	 */
	public $table_element = 'collecte_collecte';

	/**
	 * @var int  Does collecte support multicompany module ? 0=No test on entity, 1=Test with field entity, 2=Test with link by societe
	 */
	public $ismultientitymanaged = 0;

	/**
	 * @var int  Does collecte support extrafields ? 0=No, 1=Yes
	 */
	public $isextrafieldmanaged = 1;

	/**
	 * @var string String with name of icon for collecte. Must be the part after the 'object_' into object_collecte.png
	 */
	public $picto = 'collecte@collecte';
	...
	public $fields=array(
		...
		'fk_soc' => array('type'=>'integer:Societe:societe/class/societe.class.php', 'label'=>'Donneur', 'enabled'=>1, 'visible'=>1, 'position'=>50, 'notnull'=>1, 'index'=>1, 'help'=>"Donneur",),
		'date_collecte' => array('type'=>'date', 'label'=>'Date', 'enabled'=>1, 'visible'=>1, 'position'=>55, 'notnull'=>1, 'index'=>1, 'help'=>"Date de la collecte",),
		...
		'status' => array('type'=>'integer', 'label'=>'Status', 'enabled'=>1, 'visible'=>1, 'position'=>1000, 'notnull'=>1, 'index'=>1, 'arrayofkeyval'=>array('0'=>'Brouillon', '1'=>'Actif', '9'=>'Annul&eacute;')),
	);
	public $rowid;
	public $ref;
	public $label;
	public $fk_soc;
	public $date_collecte;
	public $description;
    ...
    public function getNomUrl($withpicto = 0, $option = '', $notooltip = 0, $morecss = '', $save_lastsearch_value = -1)
    {
        ...
        $label = '<u>' . $langs->trans("Collecte") . '</u>';
        $label.= '<br>';
        $label.= '<b>' . $langs->trans('Ref') . ':</b> ' . $this->ref;

        $url = dol_buildpath('/collecte/collecte_card.php', 1).'?id='.$this->id;
        ...
        if (empty($notooltip))
        {
            ...
            {
                $label=$langs->trans("ShowCollecte");
            ...
            /*
             $hookmanager->initHooks(array('collectedao'));
	...
	public function generateDocument($modele, $outputlangs, $hidedetails = 0, $hidedesc = 0, $hideref = 0, $moreparams = null)
	{
		...
		if (! dol_strlen($modele)) {
			...
			} elseif (! empty($conf->global->COLLECTE_ADDON_PDF)) {
				$modele = $conf->global->COLLECTE_ADDON_PDF;
			}
		}
