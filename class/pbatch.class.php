...
/**
 * \file        class/pbatch.class.php
 * \ingroup     PBatch
 * \brief       This file is a CRUD class file for PBatch (Create/Read/Update/Delete)
 */
 ...
 */
class PBatch extends CommonObject
{
	/**
	 * @var string ID of module.
	 */
	public $module = 'pickup';

	/**
	 * @var string ID to identify managed object.
	 */
	public $element = 'pbatch';

	/**
	 * @var string Name of table without prefix where object is stored. This is also the key used for extrafields management.
	 */
	public $table_element = 'pickup_batch';
	...
	/**
	 * @var string String with name of icon for pbatch. Must be a 'fa-xxx' fontawesome code (or 'fa-xxx_fa_color_size') or 'myobject@mymodule' if picto is file 'img/object_myobject.png'.
	 */
	...
	public $fields = array(
		...
		'fk_pickupline' => array(
			'type'=>'integer:PickupLine:pickup/class/pickupline.class.php:1',
			'label'=>'PickupLine', 'enabled'=>'1', 'position'=>3,
	...
	public function fetchAll($sortorder = '', $sortfield = '', $limit = 0, $offset = 0, array $filter = array(), $filtermode = 'AND')
	{
		...
		$sql .= " FROM ".(property_exists($this->db, 'prefix') ? $this->db->prefix : MAIN_DB_PREFIX).$this->table_element." as t";
