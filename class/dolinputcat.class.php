...
class Dolinputcat extends CommonObject
{
	 ...
	 */
	public $table_element = 'collecte_dolinputcat';
	 ...
	 */
	public $picto = 'dolinputcat@collecte';
	 ...
	 */
	//public $table_element_line = 'collecte_dolinputcatline';
	 ...
	 */
	//protected $childtablesoncascade=array('collecte_dolinputcatdet');
    ...
    public function getNomUrl($withpicto = 0, $option = '', $notooltip = 0, $morecss = '', $save_lastsearch_value = -1)
    {
        ...
        $url = dol_buildpath('/collecte/dolinputcat_card.php', 1).'?id='.$this->id;
